...
#ifndef _P4_TOP4_TORENAMEP4_H_
#define _P4_TOP4_TORENAMEP4_H_
...
*/
class ToRenameP4 : public Inspector {
 ...
 public:
    ...
    cstring mainFile;
    cstring postFix="_v1"; //Zoe for reName

    ToRenameP4(Util::SourceCodeBuilder& builder, bool showIR,cstring mainFile = nullptr) :
    ...
    { visitDagOnce = false; setName("ToRenameP4"); }
    ToRenameP4(std::ostream* outStream, bool showIR,cstring mainFile = nullptr) :
            expressionPrecedence(DBPrint::Prec_Low),
            isDeclaration(true),
            showIR(showIR),
            withinArgument(false),
