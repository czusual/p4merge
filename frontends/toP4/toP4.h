...
class ToP4 : public Inspector {
 ...
 public:
    ...
    /*Zoe merge add*/
    //cstring mergeRenameFile="MergeRenameList.txt";
    std::ofstream mergeRenameFile;
    ...
    ToP4(Util::SourceCodeBuilder& builder, bool showIR, cstring mainFile = nullptr) :
            ...
            outStream(nullptr),
            mainFile(mainFile)
    { visitDagOnce = false; setName("ToP4"); }//Zoe
